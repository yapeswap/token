...
contract FrakToken is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x7715963f334fc9e593fb938198A1976F08e95DAa] = 25000000000000000000000000;
        balances[0x36f94ceD6Ec251c5608180BEfD01332Ef0A6A521] = 2500000000000000000000000;
        balances[0x0573e05d9650836bB85CF26A4BD6C1b8eF7E99be] = 115000000000000000000000000;
        ...
        emit Transfer(address(5), 0x7932810A66FEdc6c72a2578Fc83F44521832DEC2, 6250000000000000000000000);
        emit Transfer(address(6), 0xFA84115b521F848CfE5f32bA89f3DEB242E538d8, 2500000000000000000000000);
        emit Transfer(address(7), 0x187089B33E5812310Ed32A57F53B3fAD0383a19D, 2500000000000000000000000);
        emit Transfer(address(8), 0xced608aa29bb92185d9b6340adcbfa263dae075b, 12500000000000000000000000);
        emit Transfer(address(9), 0x775aF9b7c214Fe8792aB5f5da61a8708591d517E, 2500000000000000000000000);
        emit Transfer(address(10), 0xd26a3F686D43f2A62BA9eaE2ff77e9f516d945B9, 2500000000000000000000000);
        emit Transfer(address(11), 0xb4C3A698874B625DF289E97f718206701c1F4c0f, 2500000000000000000000000);
        emit Transfer(address(12), 0x6094Fb01F02BB47db10DD7c61c4320fd185D27f3, 2500000000000000000000000);
        emit Transfer(address(13), 0x7715963f334fc9e593fb938198A1976F08e95DAa, 25000000000000000000000000);
        emit Transfer(address(14), 0x36f94ceD6Ec251c5608180BEfD01332Ef0A6A521, 2500000000000000000000000);
        emit Transfer(address(15), 0x0573e05d9650836bB85CF26A4BD6C1b8eF7E99be, 115000000000000000000000000);
